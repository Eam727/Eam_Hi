//#region Copyright (c) 2017 HIEngine 抽象资源加载器, All rights reserved.

//// HIEngine - Toolset and framework for Unity3D
//// ===================================
//// 
//// Filename: HIAbstractResourceLoader.cs
//// Date:     2017/01/18
//// Author:  Eam
//#endregion
...
//    {
//        public delegate void LoaderDelegate(bool isOk, object resultObject);
...
//        private readonly List<LoaderDelegate> _afterFinishedCallbacks = new List<LoaderDelegate>();
...
//        /// <returns></returns>
//        protected static T AutoNew<T>(string url, LoaderDelegate callback = null, bool forceCreateNew = false,
...
//            {
//                Util.LogFormat("[{0}:AutoNew]url为空", typeof(T));
//            }
...
//            {
//                Util.LogError("[DoGarbageCollect]CacheLoaderToRemoveFromUnUsed muse be empty!!");
//            }
//        }
...
//                {
//                    //Dispose();
//                    Util.LogFormat("[BaseResourceLoader:OnFinish]时，准备Disposed {0}", Url);
//                }
//            };
...
//                        Util.LogWarningFormat("Null ResultAsset {0}", Url);
...
//            {
//                Util.LogWarningFormat("[{0}]Too many dipose! {1}, Count: {2}", GetType().Name, this.Url, RefCount);
//            }
...
//                    if (RefCount < 0)
//                    {
//                        Util.LogErrorFormat("[{3}]RefCount< 0, {0} : {1}, NowRefCount: {2}, Will be fix to 0", GetType().Name,
...
//                    {
//                        Util.LogErrorFormat("[{1}]UnUsesLoader exists: {0}", this, GetType());
//                    }
//                }
...
//                    if (!bRemove)
//                    {
//                        Util.LogWarningFormat("[{0}:Dispose]No Url: {1}, Cur RefCount: {2}", type.Name, Url, RefCount);
//                    }
//                }
//            }
...
//            if (RefCount != 1)
//            {
//                Util.LogWarningFormat("[ForceDisose]Use force dispose to dispose loader, recommend this loader RefCount == 1");
//            }
//            Dispose();
//        }
